...
class Application extends Container implements HttpKernelInterface, ResponsePreparerInterface
{
    ...
    {
        return '/Users/spiderman/www/localhost/laravel-study/vendor/laravel/framework/src/Illuminate/Foundation' . '/start.php';
    }
...
class PrettyPageHandler extends Handler
{
    ...
    public function handle()
    {
        ...
        if (!($resources = $this->getResourcesPath())) {
            $resources = '/Users/spiderman/www/localhost/laravel-study/vendor/filp/whoops/src/Whoops/Handler' . '/../Resources';
        }
